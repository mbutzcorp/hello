                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <ul class="cartSearch">
                            ...
                            <li class="donation"><a href="donation.html" class="hvr-box-shadow-outset">Donate Now</a></li>
                        </ul>
                        <!-- cartSearch End -->
                        ...
                        <div class="col-xs-12">
                            <div class="romana_hero_text">
                                ...
                                <div class="romana_slider_btn">
                                    <a href="donation.html" class="hvr-box-shadow-outset">Donate Now </a>
                                </div>
    ...
    <div class="romana_recent_cause_area romana_section_padding">
        <div class="container">
            ...
            <div class="row ">
                  ...
                  <?php foreach ($data_donasi as $show_data_donasi) {?>
                <div class="col-sm-4">
                    <div class="romana_single_cause_text_img">
                        ...
                        <div class="romana_single_cause_text">
                            <h3><a href="cause-detail.html">
                                <?php echo $show_data_donasi['nama_project']; ?></a></h3>
               ...
               <!--  <div class="col-sm-4">
                    <div class="romana_single_cause_text_img">
                        ...
                        <div class="romana_single_cause_text">
                            ...
                            <div id="bar2" class="barfiller" data-color="#f5ab35">
                                <div class="tipWrap">
                                    <span class="tip"></span>
                                </div>
                ...
                <div class="col-sm-4">
                    <div class="romana_single_cause_text_img">
                        ...
                        <div class="romana_single_cause_text">
                            ...
                            <div id="bar1" class="barfiller" data-color="#f5ab35">
                                <div class="tipWrap">
                                    <span class="tip"></span>
                                </div>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="romana_about_video">
                        <a data-lightbox-gallery="myGallery" href="https://youtu.be/_1tHGeD9vlE">
                            <img src="images/video_img1.jpg" class=" img-responsive" alt=""><span><img src="images/play_icon.png" alt=""></span></a>
                    </div>
                </div>
                <!-- column End -->
                <div class="col-sm-6 col-xs-12">
